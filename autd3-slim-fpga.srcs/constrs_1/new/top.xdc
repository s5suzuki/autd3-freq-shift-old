...
set_input_delay -clock cpu_bsc_75M -min 0.5 [get_ports CPU_WE0_N]
set_input_delay -clock cpu_bsc_75M -max 1.0 [get_ports CPU_WE0_N]
set_input_delay -clock cpu_bsc_75M -min 0.5 [get_ports CPU_CS1_N]
set_input_delay -clock cpu_bsc_75M -max 1.0 [get_ports CPU_CS1_N]
set_input_delay -clock cpu_bsc_75M -min 0.5 [get_ports CPU_DATA*]
set_input_delay -clock cpu_bsc_75M -max 1.0 [get_ports CPU_DATA*]
set_input_delay -clock cpu_bsc_75M -min 0.5 [get_ports CPU_ADDR*]
set_input_delay -clock cpu_bsc_75M -max 1.0 [get_ports CPU_ADDR*]
set_output_delay -clock cpu_bsc_75M -min 0.5 [get_ports CPU_DATA*]
set_output_delay -clock cpu_bsc_75M -max 1.0 [get_ports CPU_DATA*]

create_clock -period 39.063 -name main_25P6M -waveform {0.000 19.531} [get_ports MRCC_25P6M]
set_input_delay -clock clk_out1_ultrasound_cnt_clk_gen -min 0.5  [get_ports CAT_SYNC0]
set_input_delay -clock clk_out1_ultrasound_cnt_clk_gen -max 1.5 [get_ports CAT_SYNC0]
set_output_delay -clock clk_out1_ultrasound_cnt_clk_gen -min 0.5 [get_ports FORCE_FAN]
set_output_delay -clock clk_out1_ultrasound_cnt_clk_gen -max 1.5 [get_ports FORCE_FAN]
set_output_delay -clock clk_out1_ultrasound_cnt_clk_gen -min 0.5 [get_ports XDCR_OUT*]
set_output_delay -clock clk_out1_ultrasound_cnt_clk_gen -max 1.5 [get_ports XDCR_OUT*]
