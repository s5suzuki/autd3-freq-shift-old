...
set_input_delay -clock main_25P6M -min 0.5  [get_ports CAT_SYNC0]
set_input_delay -clock main_25P6M -max 1.5 [get_ports CAT_SYNC0]
set_output_delay -clock main_25P6M -min 0.5 [get_ports FORCE_FAN]
set_output_delay -clock main_25P6M -max 1.5 [get_ports FORCE_FAN]
set_output_delay -clock main_25P6M -min 0.5 [get_ports XDCR_OUT*]
set_output_delay -clock main_25P6M -max 1.5 [get_ports XDCR_OUT*]
