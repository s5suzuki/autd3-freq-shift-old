...
class SOEMController {
 public:
  ...
  void open(const char* ifname, size_t dev_num, ECConfig config, const std::vector<uint16_t>& freq_cycles);
 ...
 private:
  void setup_sync0(bool activate, const std::vector<uint16_t>& freq_cycles) const;
